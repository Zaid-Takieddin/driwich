            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <section class="container mx-auto p-6 font-mono">
                    <div class="w-full flex mb-4 p-2 justify-end">
                        <Link :href="route('admin.hamburgers.create')" class="px-4 py-2 bg-green-600 hover:bg-green-800 text-white rounded-lg">Add Hamburger</Link>
                    </div>
                        ...
                        <div class="w-full overflow-x-auto">
                            <table class="w-full">
                                ...
                                <tbody class="bg-white">
                                        ...
                                        <tr v-for="hamburger in hamburgers" :key="hamburger.id" class="text-gray-700">
                                            ...
                                            <td class="flex justify-around px-4 py-3 text-sm border">
                                                <Link :href="route('admin.hamburgers.edit', hamburger.id)"
                                                    class="bg-green-500 hover:bg-green-700 text-white px-4 py-2 rounded-lg">Edit</Link>
                                                <Link :href="route('admin.hamburgers.destroy', hamburger.id)" method="delete" as="button" type="button"
