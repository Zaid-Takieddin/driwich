<template>
  <div class="w-full text-gray-700 bg-white dark:text-gray-200 dark:bg-gray-800 sticky top-0 z-10">
    <div x-data="{ open: false }"
        ...
        <div class="p-4 flex flex-row items-center justify-between space-x-2">
            <Link :href="route('welcome.index')"
                class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark:text-white focus:outline-none focus:shadow-outline">Driwich</Link>
        ...
        <nav :class="{'flex': open, 'hidden': !open}"
            ...
            <Link class="bg-transparent px-4 py-2 mt-2 text-sm font-semibold rounded-lg dark:hover:bg-gray-600 dark:focus:bg-gray-600 dark:focus:text-white dark:hover:text-white dark:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                :href="route('hamburgers.index')">Hamburgers</Link>
            <Link class="bg-transparent px-4 py-2 mt-2 text-sm font-semibold rounded-lg dark:hover:bg-gray-600 dark:focus:bg-gray-600 dark:focus:text-white dark:hover:text-white dark:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                :href="route('pizzas.index')">Pizzas</Link>
            <Link class="bg-transparent px-4 py-2 mt-2 text-sm font-semibold rounded-lg dark:hover:bg-gray-600 dark:focus:bg-gray-600 dark:focus:text-white dark:hover:text-white dark:text-gray-200 md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline"
                :href="route('drinks.index')">Drinks</Link>
